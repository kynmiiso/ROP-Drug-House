...
screen case_description:
    ...
    $ item_name = "Case A"
    $ item_desc = "On the night of August 6th, a house suspected of drug trafficking was raided by police under a search warrant. Records indicate the residence was owned by Doorag Deelur. His neighbour, Methany Phentamy, was identified as a frequent visitor to the property and is the accused in this case.\n\nDuring the search, officers recovered three bags of a suspected controlled substance, a firearm, and a large sum of cash hidden throughout the residence. A latent fingerprint later developed on the firearm was compared against records on file and returned a candidate match to Phentamy. Phentamy denies any involvement in drug trafficking and claims she was never inside the residence, but neighbours reported seeing her enter and leave the property on multiple occasions in the weeks prior to the raid.\n\nForensic analysis of the recovered samples, along with the fingerprint evidence tying Phentamy to the firearm found on scene, forms the basis of the case against her."
