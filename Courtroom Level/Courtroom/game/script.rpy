...
label start:
    ...
    s "On the night of August 6th, police executed a search warrant on a house suspected of being used for drug trafficking."
    s "The house is registered to Doorag Deelur, though records show he only actually lives there for about half the year, spending half of his time living abroad."
    s "Because of that arrangement, Deelur himself remains a person of interest, but he was out of town at the time of the raid and has an alibi that's still being verified."
    s "The accused, Methany Phentamy, is Deelur's neighbour. She was seen entering and leaving the house on multiple occasions in the weeks before the raid."
    s "Inside, officers recovered three bags of a suspected controlled substance, a firearm, and a large sum of cash hidden throughout the residence."
    s "A latent fingerprint was developed on the firearm and returned a candidate match to Phentamy."
    s "Phentamy denies ever being inside the house and claims she was simply seen near the property, not entering it."
    s "The prosecution insists that with Deelur away for extended periods of time, Phentamy took advantage of his absence to use the property for trafficking, while the defense argues that someone else, possibly Deelur himself, could just as easily be responsible."
